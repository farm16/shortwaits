...
export const ContactsSettings = ({ business }: { business: BusinessDtoType }) => {
  ...
  return (
    ...
    >
      <List.Item
        ...
        right={props => <List.Icon {...props} color={Colors.text} icon="cloud-upload-outline" />}
      />
      ...
      <List.Item
        ...
        descriptionStyle={{ color: Colors.subText }}
        title="Sync Contacts"
        right={props => <List.Icon {...props} color={Colors.text} icon="book-sync" />}
      />
    </List.Accordion>
  );
};
