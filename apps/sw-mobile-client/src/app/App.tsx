        ...
        >
          ...
          <View style={styles.section}>
            <View style={[styles.shadowBox]}>
              ...
              <TouchableOpacity style={[styles.listItem, styles.learning]} onPress={() => Linking.openURL("https://blog.nrwl.io/?utm_source=nx-project")}>
                <Svg width={24} height={24} stroke="#000000" fill="none" viewBox="0 0 24 24">
                  <Path
                    strokeLinecap="round"
                    strokeLinejoin="round"
              ...
              <TouchableOpacity style={[styles.listItem, styles.learning]} onPress={() => Linking.openURL("https://www.youtube.com/@NxDevtools/videos?utm_source=nx-project")}>
              ...
              <TouchableOpacity style={[styles.listItem, styles.learning]} onPress={() => Linking.openURL("https://nx.dev/react-tutorial/1-code-generation?utm_source=nx-project")}>
                <Svg width={24} height={24} stroke="#000000" fill="none" viewBox="0 0 24 24">
                  <Path
                    strokeLinecap="round"
                    strokeLinejoin="round"
              ...
              <TouchableOpacity style={[styles.listItem, styles.learning]} onPress={() => Linking.openURL("https://nxplaybook.com/?utm_source=nx-project")}>
                <Svg width={24} height={24} stroke="#000000" fill="none" viewBox="0 0 24 24">
          ...
          <View style={[styles.section, styles.shadowBox]}>
            <TouchableOpacity onPress={() => Linking.openURL("https://marketplace.visualstudio.com/items?itemName=nrwl.angular-console&utm_source=nx-project")}>
