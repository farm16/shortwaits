...
import { ClientsSelectorItem } from "./local-clients-selector-item";
...
export const LocalClientsSelectorModal: FC<ModalsScreenProps<"business-clients-modal-screen">> = ({ navigation, route }) => {
  const {
    searchable = false,
    headerTitle = "Clients",
