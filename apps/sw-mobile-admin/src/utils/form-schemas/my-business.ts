import { UpdateBusinessDtoType, EventPaymentMethodType, eventPaymentMethods } from "@shortwaits/shared-lib";
...
export const updateBusinessSchema: Yup.SchemaOf<UpdateBusinessDtoType> = Yup.object().shape({
