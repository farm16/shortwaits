...
export const createLocalClientUserSchema: (config: any) => Yup.SchemaOf<CreateLocalClientUserDtoType> = config =>
  Yup.object().shape({
...
export const addClientToBusinessSchema: (config: any) => Yup.SchemaOf<AddClientToBusinessDtoType> = config =>
  Yup.object().shape({
    shortId: Yup.string().required("this field is required"),
  });

export const createBusinessUserSchema: (config: any) => Yup.SchemaOf<CreateBusinessUserDtoType> = config =>
  Yup.object().shape({
...
export const updateClientUserSchema: (config) => Yup.SchemaOf<CreateClientUserDtoType> = config =>
  Yup.object().shape({
    clientType: Yup.mixed().required().oneOf(["local", "external"]),
...
export const updateBusinessUserSchema: (config) => Yup.SchemaOf<CreateBusinessUserDtoType> = config =>
  Yup.object().shape({
