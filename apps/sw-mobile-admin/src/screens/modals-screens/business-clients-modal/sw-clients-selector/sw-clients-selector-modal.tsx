...
import { ClientsSelectorItem } from "./sw-clients-selector-item";
...
export const SwClientsSelectorModal: FC<ModalsScreenProps<"business-clients-modal-screen">> = ({ navigation, route }) => {
  const {
    searchable = false,
    headerTitle = "Clients",
