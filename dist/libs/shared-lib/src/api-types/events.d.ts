import { CommonResponseType, ClientUsersDtoType, BusinessUsersDtoType } from ".";
import { ConvertToDtoType, EventType, WithDbProps } from "..";
export type FilteredEvent = Pick<EventType, "paymentMethod" | "participantsIds" | "urls" | "location" | "attendeeLimit" | "registrationFee" | "hasNoDuration" | "eventImage" | "name" | "description" | "features" | "durationInMin" | "priceExpected" | "isPublicEvent" | "repeat" | "notes" | "labels" | "registrationDeadlineTime" | "leadClientId" | "serviceId" | "businessId" | "clientsIds" | "staffIds" | "startTime" | "expectedEndTime">;
