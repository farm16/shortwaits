...
export const createClientUserSchema: Yup.Schema<CreateClientUserDtoType> =
  Yup.object().shape({
    ...
    password: Yup.string()
      ...
      .optional(), // this is not required for clientType: "local"
...
export const createBusinessUserSchema: Yup.Schema<CreateBusinessUserDtoType> =
  Yup.object().shape({
    hours: Yup.object().required(),
    alias: Yup.mixed()
      .required()
      .oneOf(['familyName', 'givenName', 'middleName', 'displayName'])
      .optional(),
    displayName: Yup.string()
      .min(3, 'a longer name is required')
      .required('this field is required'),
...
export const updateClientUserSchema: Yup.Schema<CreateClientUserDtoType> =
  Yup.object().shape({
    clientType: Yup.mixed().required().oneOf(['local', 'external']),
    username: Yup.string()
      .min(3, 'a longer name is required')
...
export const updateBusinessUserSchema: Yup.Schema<CreateBusinessUserDtoType> =
  Yup.object().shape({
    alias: Yup.mixed()
      .required()
      .oneOf(['familyName', 'givenName', 'middleName', 'displayName']),
