...
import { ClientsSelectorItem } from "./sw-clients-list-item";
...
export const SwClientsListModal: FC<ModalsScreenProps<"business-clients-modal-screen">> = ({ navigation, route }) => {
  const {
    searchable = false,
    headerTitle = "Clients",
