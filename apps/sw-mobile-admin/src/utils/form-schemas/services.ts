...
export const createServiceSchema: Yup.SchemaOf<CreateServiceDtoType> = Yup.object().shape({
...
export const updateServiceSchema: Yup.SchemaOf<CreateServiceDtoType> = Yup.object().shape({
  businessId: Yup.string(),
  name: Yup.string().min(3, "a longer name is required").required("this field is required"),
  description: Yup.string().optional(),
  hours: Yup.object()
