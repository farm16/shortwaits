...
export const createServiceSchema: Yup.Schema<CreateServiceDtoType> = Yup.object({
...
export const updateServiceSchema: Yup.Schema<CreateServiceDtoType> = Yup.object({
  businessId: Yup.string(),
  name: Yup.string().min(3, "a longer name is required").required("this field is required"),
  description: Yup.string().optional(),
  hours: Yup.object()
