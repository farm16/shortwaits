...
export const Google = (props: SvgProps) => (
  <Svg
    ...
    <Path
      ...
      d="m372.97 215.509-36.521 43.939-68.763-71.518h-95.008l-38.453 41.637v89.912L318.85 504.217c83.594-21.102 150.816-83.318 178.916-163.887L372.97 215.509z"
    />
    <Path
      style={{
        fill: '#fff',
