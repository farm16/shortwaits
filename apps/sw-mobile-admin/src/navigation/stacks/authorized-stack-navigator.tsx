...
import { AppInfoScreen, BusinessClientScreen, BusinessLocalClientScreen, BusinessProfileScreen, BusinessStaffScreen, EventScreen, PlansScreen } from "../../screens";
...
export const AuthorizedStackNavigator = () => {
  return (
    <Stack.Navigator>
      ...
      <Stack.Screen name={AUTHORIZED_STACK_SCREENS.BUSINESS_LOCAL_CLIENT_SCREEN} component={BusinessLocalClientScreen} />
