...
import { AnimatedSearchBar, BackButton, Container, IconButton, NonIdealState, NonIdealStateTypes, Screen } from "../../../../../";
  ...
  const handleOnChangeText = (text: string) => {
    ...
    const filteredItems = data?.filter(item => {
      ...
      if (typeof item === "string") {
        return (item as string).toLowerCase().includes(text.toLowerCase());
      } else {
