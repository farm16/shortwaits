...
export const createEventSchema: Yup.SchemaOf<CreateEventDtoType> =
  Yup.object().shape({
    ...
    isGroupEvent: Yup.boolean().optional(),
...
export const updateEventSchema: Yup.SchemaOf<UpdateEventDtoType> =
  Yup.object().shape({
    paymentMethod: paymentMethodSchema,
    participantsIds: Yup.array().of(Yup.string()),
    urls: Yup.array().of(
